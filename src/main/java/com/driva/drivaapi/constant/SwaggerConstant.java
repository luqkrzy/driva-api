...
public class SwaggerConstant {
    ...
    public static final String CONTACT_URL = "https://www.someurl.com";
    public static final String CONTACT_NAME = "Driva API Support";
    public static final String API_TITLE = "Driva Management open API";
    ...
    public static final String API_TAG = "Driva Service";
}
